...
public class AIPluginRunner : IAIPluginRunner
{
    ...
    public async Task<HttpResponseData> RunAIPluginOperationAsync(HttpRequestData req, string operationId)
    {
        ...
        var pluginsDirectory = Path.Combine(System.IO.Directory.GetCurrentDirectory(),"Prompts");
        //var func = this._kernel.ImportSemanticFunctionsFromDirectory(pluginsDirectory,appSettings.AIPlugin.NameForModel);
        ...
        // catch exception if result is null and return error response
