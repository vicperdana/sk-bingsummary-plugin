...
using skchatgptazurefunction.PluginShared;
using skchatgptazurefunction.WebSearcher.Models;

/// <summary>
/// Plugin endpoints
/// </summary>
namespace skchatgptazurefunction.WebSearcher
{
    public class BingSearch
    {
        ...
        public BingSearch(PluginConfig config, ILogger<BingSearch> logger)
        {
            this._config = config;
            this._logger = logger;
        }
        ...
        public async Task<HttpResponseData> WellKnownAIPluginManifest(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get")] HttpRequestData req, PluginConfig pluginConfig)
        {
        ...
        [Function("WebSearch")]
        public async Task<HttpResponseData> WebSearch([HttpTrigger(AuthorizationLevel.Function, "get", Route = "search")] HttpRequestData req, PluginConfig pluginConfig)
        {
            ...
            int offset;
            if (!queries.ContainsKey("Offset") || !int.TryParse(queries["Offset"], out offset))
            {
                offset = 0; // default value
            }
            else
            {
                // offset now contains the parsed integer
            }
...
/*
 * Function 'WebSearch', Invocation id '0bae7edc-2ffc-404b-9262-7a19349e7360': An exception was thrown by the invocation.
[2023-10-18T02:54:36.730Z] Result: Function 'WebSearch', Invocation id '0bae7edc-2ffc-404b-9262-7a19349e7360': An exception was thrown by the invocation.
[2023-10-18T02:54:36.730Z] Exception: System.InvalidOperationException: Unable to resolve service for type 'skchatgptazurefunction.Models.PluginConfig' while attempting to activate 'skchatgptazurefunction.BingSearch'.
[2023-10-18T02:54:36.730Z]    at Microsoft.Extensions.DependencyInjection.ActivatorUtilities.ConstructorMatcher.CreateInstance(IServiceProvider provider)
[2023-10-18T02:54:36.730Z]    at Microsoft.Extensions.DependencyInjection.ActivatorUtilities.CreateInstance(IServiceProvider provider, Type instanceType, Object[] parameters)*/
